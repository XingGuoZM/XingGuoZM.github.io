  ...
  export default () => {
    ...
    return <div style={{fontSize:'0.26rem'}} dangerouslySetInnerHTML={{__html:`<h3>React概念和理解</h3>
<ul>
<li>说说你对react的理解？</li>
<li>有哪些特性？</li>
<li>React的设计思想？</li>
...
<pre><code>React是用于构建用户界面的JavaScript库，只提供了UI层面的解决方案。遵循组件设计模式、声明式编程范式和函数式编程概念，以使前端应用程序更高效。使用虚拟DOM来有效地操作DOM，遵循从高阶组件到低阶组件的单向数据流，帮助我们将界面成了各个独立的小块，每一个块就是组件，这些组件之间可以组合、嵌套，构成整体页面。react 类组件使用一个名为render()的方法或者函数组件return，接收输入的数据并返回需要展示的内容
...
<h3>HOC</h3>
<ul>
<li>对函数式编程的理解？对高阶组件（HOC）的理解？什么渲染劫持？</li>
<li>举例说明React的插槽有哪些运用场景？</li>
<li>你有用过React的插槽(Portals)吗？怎么用？</li>
</ul>
<h3>React执行</h3>
<ul>
...
<li>在React中怎么将参数传递给事件？</li>
<li>在React中怎么阻止事件的默认行为？</li>
<li>举例说明如何在React创建一个事件</li>
</ul>
<h3>React规范</h3>
<ul>
<li>React的严格模式有什么用处？</li>
<li>React中在哪捕获错误？</li>
...
<li>React的生命周期？说说React生命周期有哪些不同的阶段？每个阶段对应的方法是？</li>
...
<li>函数式组件有没有生命周期？为什么？</li>
<li>说说你对React的reconciliation（一致化算法）的理解？</li>
<li>使用Hooks要遵守哪些原则？</li>
<li>请描述下你对React的新特性Hooks的理解？它有哪些应用场景？</li>
<li>React hook解决了什么问题？函数组件和类组件区别？为什么不能在条件语句中写Hook？</li>
...
<li>在React中如果去除生产环境上的sourcemap？</li>
</ul>
<h3>React组件与三方库</h3>
<ul>
...
<h3>React18有哪些更新？React 16+和React15的区别？IE支持情况？</h3>
<h3>React怎样引入svg的文件？</h3>
<h2>冷门</h2>
<ul>
...
React为什么要搞一个Hooks？
React Hooks帮我们解决了哪些问题？</p>
<p>组件卸载前，加在DOM元素的监听事件和定时器要不要手动清除？为什么？
...
简单描述下你有做过哪些React项目？
在构造函数中调用super(props)的目的是什么？</p>
<p>从旧版本的React升级到新版本的React有做过吗？有遇到过什么坑？
你用过React版本有哪些？</p>
<p>有用过React的服务端渲染吗？怎么做的？
...
使用React的方式有哪几种？
说说你对reader的context的理解</p>
<p>React自定义组件你写过吗？说说看都写过哪些？
